...
export default function DjangoPozicijosPage() {
  ...
  return (
    <div className="container">
      <Header
        title="Django Pozicijos"
        subtitle="React rodo realų pozicijų sąrašą ir atskirai krauna pasirinktos pozicijos detales iš Django"
      />
              ...
              rows.map((row) => (
                ...
                >
                  <div>
                    ...
                    <div className="rowMeta" style={{ marginTop: 4 }}>
                      Kiekis: {row.kiekis ?? "—"} {row.mato_vnt || ""}
                    </div>
                  </div>
                </div>
              ))
